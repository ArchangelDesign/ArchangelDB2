                     ...
                     Profiler\ProfilerAwareInterface
{
    ...
    public function __construct($connection,
        ...
        Result $resultPrototype = null, $features = self::FEATURES_DEFAULT)
    {
    ...
    public function createResult($resource, $context = null)
    {
        ...
        $result->initialize(
            $resource, $this->connection->getLastGeneratedValue(), $rowCount
        );
        return $result;
    }
    ...
    {
        if ($type == null && !is_numeric($name) ||
            $type == self::PARAMETERIZATION_NAMED) {
            return ':' . $name;
        }
